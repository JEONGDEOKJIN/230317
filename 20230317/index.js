...
// 전역변수만으로 프로그렘을 관리하기에는 너무 힘들기때문에
// 오브젝트화 객체화 시킨다.
// 개발자는 객체를 잘 다뤄야한다.
let obj1_name = "고블린";
let obj1_atk = 100;
...
// for in
// 자동완성 했을때 object라고 적혀있는 변수에 우리가 보고싶은
// 객체를 넣어준다
...
// ID ------------------------------------------------------------------
// getElementById 메소드로 태그의 아이디를 찾아서 태그를 가져올수있다.
...
// 태그 이름 선택자  -------------------------------------------------------
// querySelector 변수의 내용은 CSS 선택를 넣어주는거구나
// 문자열로 넣어주면된다.
let div6 = document.querySelector('div');
// -----------------------------------------------------------------------

// 이제 우리는 웹페이지를 만들수 있는 능력이 생겼어
// 대단한 사람이 됬다.
...
// 버튼을 누르면 함수를 실행시켜보자.
function btnFn(){
    // class_div2 클래스를 가지고있는 태그들을 class_div변수에 배열로 담고
